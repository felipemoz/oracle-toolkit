...
REPHEADER LEFT COL 9 '************************************************* ' SKIP 1 -
               COL 9 '* TOP 10 ELAPSED_TIME TOTAL SQL_IDS FROM MODULE : ' &&pModule SKIP 1 -
               COL 9 '************************************************* ' SKIP 2
...
,      ROUND((SUM(elapsed_time_delta)/DECODE(SUM(a.executions_delta),0,1,SUM(a.executions_delta)))/1000000,3) at --non zero executions
